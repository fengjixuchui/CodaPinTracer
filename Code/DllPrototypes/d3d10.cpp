...
libcall_info_t d3d10_info[] = {
	...
	{ "D3D10CreateDeviceAndSwapChain",8,
	{ 
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, INOUT },
		...
		{4, "SDKVersion", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, IN },
		{5, "pSwapChainDesc", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_Pointer, "DXGI_SWAP_CHAIN_DESC", 480, IN },
		{6, "ppSwapChain", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_PointerPointer, "IDXGISwapChain", 32, IN },
		{7, "ppDevice", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_PointerPointer, "ID3D10Device", 32, IN },
	}
	},
	...
	{ 
		...
		{3, "Flags", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, IN },
		{4, "SDKVersion", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, IN },
		{5, "ppDevice", NKT_DBOBJCLASS_Struct | NKT_DBOBJCLASS_PointerPointer, "ID3D10Device", 32, IN },
	}
	},
};

int d3d10arraySize = (sizeof(d3d10_info) / sizeof(d3d10_info[0]));
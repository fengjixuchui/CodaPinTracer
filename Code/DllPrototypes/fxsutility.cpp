...
libcall_info_t fxsutility_info[] = {
	{ "DllRegisterServer",0,
	{ 
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, INOUT },
	}
	},
	{ "CanSendToFaxRecipient",0,
	{ 
		{-1, "Return value", NKT_DBFUNDTYPE_SignedDoubleWord, 0, 4, INOUT },
	}
	},
	...
	{ "SendToFaxRecipient",2,
	{ 
		{-1, "Return value", NKT_DBFUNDTYPE_UnsignedDoubleWord, 0, 4, INOUT },
		{0, "sndMode", NKT_DBOBJCLASS_Enumeration, "SendToMode", 32, IN },
...
int fxsutilityarraySize = (sizeof(fxsutility_info) / sizeof(fxsutility_info[0]));